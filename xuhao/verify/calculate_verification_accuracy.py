...
if __name__ == "__main__":
    ...
    # print("********************************** Problem Level **********************************")
    # get_verification_accuracy_plevel(verification_result_file="xuhao/sft/data/output/verification_result_llama-3.1-8b-sft_0.json", solution_label_file="xuhao/solve/data/output/solution_label_test.json")
    # print("********************************** Step Level **********************************")
    ...
    # print("********************************** Problem Level **********************************")
    # get_verification_accuracy_plevel(verification_result_file="xuhao/sft/data/output/verification_result_llama-3.1-8b-sft_19.json", solution_label_file="xuhao/solve/data/output/solution_label_test.json")
    # print("********************************** Step Level **********************************")
    ...
    get_verification_accuracy_plevel(verification_result_file="xuhao/verify/data/output/verification_result_test_llama-3.1-8b-sft-1-update-few-shot.json", solution_label_file="xuhao/solve/data/output/solution_label_test.json")